...
int main() {
    ...
    vector<int> robot = {2, 6, 8};
    vector<vector<int>> factory = {{3, 1}, {5, 2}, {7, 1}};
    
    long long result = solution.minimumTotalDistance(robot, factory);
    cout << "Minimum Total Distance: " << result << endl;
}