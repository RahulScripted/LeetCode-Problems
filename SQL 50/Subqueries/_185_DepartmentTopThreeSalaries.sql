...
-- 2.  departmentId is a foreign key (reference column) of the ID from the Department table.

-- 3.  Each row of this table indicates the ID, name, and salary of an employee. It also contains the ID of their department.
...
-- 2.  Each row of this table indicates the ID of a department and its name.
