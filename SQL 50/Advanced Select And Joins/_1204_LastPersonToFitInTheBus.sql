...
-- 1.  person_id column contains unique values.

-- 2.  This table has the information about all people waiting for a bus.

-- 3.  The person_id and turn columns will contain all numbers from 1 to n, where n is the number of rows in the table.

-- 4.  turn determines the order of which the people will board the bus, where turn=1 denotes the first person to board and turn=n denotes the last person to board.
